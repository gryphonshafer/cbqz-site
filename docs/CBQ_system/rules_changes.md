...
What follows is commentary about recent Christian Bible Quizzing (CBQ) rules changes. The goal is to help explain and provide clear justification for the changes. The changes are discussed in reverse chronological order.

| Change Title | Version | Date Applied |
|-|-|-|
| [Bible Distribution](#bibledistribution) | [1.5](https://github.com/gryphonshafer/cbqz-site/commit/afb599082582432d6693fe36cdd20d3c4922b9fd) | March 17, 2025 |
| [Open Book](#openbook:quotesceilingsandcoachauthority) | [1.4](https://github.com/gryphonshafer/cbqz-site/commit/3d5cd863b94de2c69718fff9840022ed82fa9952) | July 31, 2025 |
